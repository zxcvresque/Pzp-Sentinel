...
const DONOR: Slide[] = [
  slide("01 · Contribute", "Choose how you want to support", "Give once or monthly through Razorpay or BMC, or submit an outside contribution with proof.", "#6FD1D7", [["My Donations", "/donor"], ["Checkout", "/donor#razorpay"], ["Manual proof", "/donor#manual"]], [["Razorpay", "UPI, cards and supported wallets.", "payment"], ["Buy Me a Coffee", "A simple USD option for international donors.", "coffee"], ["Monthly support", "Autopay records every renewal automatically under your name.", "clock"], ["Manual contribution", "Attach proof for admin review.", "receipt"]], "PAYMENTS"),
