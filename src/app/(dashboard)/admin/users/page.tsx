        ...
        >
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-[var(--text-primary)]">Delete user permanently?</h3>
                <p className="text-xs text-[var(--text-tertiary)] mt-0.5">This cannot be undone</p>
              </div>
            </div>

            <div className="rounded-lg p-3 mb-5" style={{ background: "var(--bg-deep)" }}>
              <div className="text-sm font-medium text-[var(--text-primary)]">{deleteTarget.name}</div>
